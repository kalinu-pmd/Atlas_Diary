...
function PostDetails() {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center h-[77vh] bg-white border-0 ">
        <div
          ...
          {post.selectedFile.map((image, idx) => (
            <img
              ...
              style={{
                maxHeight: 500,
                minHeight: 300,
                marginBottom: idx < post.selectedFile.length - 1 ? 10 : 0,
              }}
              onError={(e) => {
              ...
              post.selectedFile.length > 1 && (
                <>
                  <button
                    onClick={() =>
                      setCurrentImageIndex(
                        (prev) =>
                          (prev - 1 + post.selectedFile.length) %
                  ...
                  <button
                    onClick={() =>
                      setCurrentImageIndex(
                        (prev) => (prev + 1) % post.selectedFile.length,
                      )
                    }
